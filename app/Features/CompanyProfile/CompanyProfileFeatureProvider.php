...
namespace App\Features\CompanyProfile;
...
class CompanyProfileFeatureProvider extends ServiceProvider
{
    public $featureName = "CompanyProfile";

    public $featureNameLower = "companyprofile";
