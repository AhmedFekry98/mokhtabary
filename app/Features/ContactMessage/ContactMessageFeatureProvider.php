...
namespace App\Features\ContactMessage;
...
class ContactMessageFeatureProvider extends ServiceProvider
{
    public $featureName = "ContactMessage";

    public $featureNameLower = "contactmessage";
